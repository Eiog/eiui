...
import OCollapse from '@eiui/components/collapse/src/collapse.vue'
import OCollapseItem from '@eiui/components/collapse/src/collapseItem.vue'
import { config, mount } from '@vue/test-utils'
import type { OCollapseItemInstance } from '@eiui/components/collapse/src/props'
